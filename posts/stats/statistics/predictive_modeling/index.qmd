...
1.  Preprocessing (data cleaning/wrangling)
    ...
    recipes::recipe() recipes::step\_<functions>()
...
3.  Model fit and prediction
    ...
    parsnip::<model_type>() %\>% set_mode() %\>% set_engine() parsnip::extract_fit_engine() / extract_fit_parsnip() tune::fit_resamples() parsnip::fit() stats::predict()
